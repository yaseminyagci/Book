...
namespace Web
{
    public static class ConfigureExtensions
    {
        ...
        public static IServiceCollection ConfigureHangfire(this IServiceCollection services)
        {
            ...
            //    .UseBookgreSqlStorage(Startup.StaticConfig.GetConnectionString("DefaultBookgre"),
            //        new BookgreSqlStorageOptions
            //        {
            //            SchemaName = "hangfire"
            //        }));
        ...
        public static IServiceCollection ConfigureDatabase(this IServiceCollection services)
        {
            ...
            //services.AddDbContext<ApplicationDbContext>(
            //options => options.UseNpgsql(Startup.StaticConfig.GetConnectionString("DefaultBookgre")));
            return services;
        }
        public static IServiceCollection ConfigureRepositories(this IServiceCollection services)
        {
            ...
            services.AddScoped<IRepository<TagBook>, Repository<TagBook>>();
