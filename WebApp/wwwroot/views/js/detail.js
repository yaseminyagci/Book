...
const constants = {
    ...
    likesGetUrl: URLS.LIKES.GETBYBOOK,
...
const functions = {
    ...
    getLikes: () => {
        ...
        var btn = constants.likedButton;
            request.Get(constants.likesGetUrl + constants.BookId.val(),
            null,
            function (response) {
    ...
    setTagsSelectData: () => {
        constants.comments = selector.getComments(constants.BookId[0].value);
