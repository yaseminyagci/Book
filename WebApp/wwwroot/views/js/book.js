...
const constants = {
    ...
    addModalTitle: "Yeni Book Ekle",
    editModalTitle: "Book Düzenle",
    ...
    deleteUrl: URLS.BOOK.DELETE,
    dataTableUrl: URLS.BOOK.GET_ALL,
    detailUrl: URLS.BOOK.DETAILPAGE,
    tagBooks: $("#tags"),
    selectedTags:[],
...
const main = {
                ...
                columns: [
                    ...
                    //},
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            let editHtml = `  <a class="dropdown-item" href="${URLS.BOOK.EDITPAGE}${data}"><i class="la la - edit"></i> Düzenle</a>`
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="${URLS.BOOK.DETAILPAGE}${data}"><i class="la la - edit"></i> Detay</a>
    ...
    buildEvents: () => {
        ...
        $(document).on("click",
                "#addBtn",
                function () {
                    window.location.href = URLS.BOOK.ADDPAGE;                
                });
