...
function buildNativeFormattingFunc(standardDateProps, extendedSettings, context) {
    ...
    return function (date) {
        ...
        return BookProcess(s, date, standardDateProps, extendedSettings, context);
    };
}
...
function BookProcess(s, date, standardDateProps, extendedSettings, context) {
...
function buildRequestParams(meta, range, calendar) {
    ...
    // retrieve any outbound GET/Book data from the options
