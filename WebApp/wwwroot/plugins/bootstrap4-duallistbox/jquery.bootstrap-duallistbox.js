...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      helperSelectNameBookfix: '_helper',                                                 // 'string_of_Bookfix' / false
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.setHelperSelectNameBookfix(this.settings.helperSelectNameBookfix);
    ...
    setHelperSelectNameBookfix: function(value, refresh) {
      this.settings.helperSelectNameBookfix = value;
      if (value) {
