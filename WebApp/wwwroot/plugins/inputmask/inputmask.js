...
!function webpackUniversalModuleDefinition(root, factory) {
    ...
    return modules = [ function(module) {
        ...
        Inputmask.extendAliases({
            ...
            ssn: {
                mask: "999-99-9999",
                BookValidation: function BookValidation(buffer, pos, c, currentResult, opts, maskset, strict) {
        ...
        module.exports = function maskScope(actionObj, maskset, opts) {
            ...
            function isValid(pos, c, strict, fromIsValid, fromAlternate, validateOnly) {
                ...
                if ($.isFunction(opts.BookValidation) && !0 !== fromIsValid && !0 !== validateOnly) {
                    var BookResult = opts.BookValidation.call(el, getBuffer(!0), void 0 !== pos.begin ? isRTL ? pos.end : pos.begin : pos, c, result, opts, maskset, strict);
                    void 0 !== BookResult && (result = !0 === BookResult ? result : BookResult);
                }
